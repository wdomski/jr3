#ifndef JR3PCI_DRIVER_HEADER

#define JR3PCI_DRIVER_HEADER
...
#define PCI_DEVICE_ID_JR3_SINGLE        0x1111 /* PCI Device ID - Single channel PCI. 6DOF sensor*/
#define PCI_DEVICE_ID_JR3_SINGLE_2      0x3111 /* PCI Device ID - Single channel PCI. 6DOF sensor*/
#define PCI_DEVICE_ID_JR3_DOUBLE        0x3112 /* PCI Device ID - Double channel PCI. Two 6DOF sensors or one 12DOF sensor*/
